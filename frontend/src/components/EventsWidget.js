...
const LocalistWidget = () => {
  useEffect(() => {
    // Create the script element
    const script = document.createElement('script');
    script.src = "https://happenings.wustl.edu/widget/view?schools=wustl&days=31&num=50&hideimage=1&experience=inperson&container=localist-widget-75947779&template=modern";
  ...
  return (
    <div>
      <div id="localist-widget-75947779" className="localist-widget"></div>
